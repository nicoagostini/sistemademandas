...
class DemandaControle extends controle{
	...
	protected function selecionarTodos($obj){
        $bd = new bd();
	...
	protected function inserir($demanda){
        ...
        /*
        	...
        	MUDEI AQUI!!!
        	Alterei a parte que insere na coluna "finalizada"... Em vez de passar a variável $demanda->finalizada(),
        	eu passei NULL, pq uma demanda nunca vai estar finalizada qdo for submetida! E isso previne erros
        	em outros bancos ou em outras versões do MySQL!
			Qualquer coisa voltem como tava <3
